...
frmLose.Picture = LoadPicture("mov1.JPG")
End If
If Counter = 6 Then
frmLose.Picture = LoadPicture("mov2.JPG")
End If
If Counter = 9 Then frmLose.Picture = LoadPicture("mov3.JPG")
If Counter = 12 Then
